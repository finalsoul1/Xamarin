...
namespace Com.Example.CO.Helloaar {
	...
	// Metadata.xml XPath interface reference: path="/api/package[@name='com.example.co.helloaar']/interface[@name='SayHello']"
	[Register ("com/example/co/helloaar/SayHello", "", "Com.Example.CO.Helloaar.ISayHelloInvoker")]
	public partial interface ISayHello : IJavaObject {

		// Metadata.xml XPath method reference: path="/api/package[@name='com.example.co.helloaar']/interface[@name='SayHello']/method[@name='sayHello' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		[Register ("sayHello", "(Ljava/lang/String;)Ljava/lang/String;", "GetSayHello_Ljava_lang_String_Handler:Com.Example.CO.Helloaar.ISayHelloInvoker, SayHelloLib")]
		string SayHello (string p0);

	}

	[global::Android.Runtime.Register ("com/example/co/helloaar/SayHello", DoNotGenerateAcw=true)]
	internal class ISayHelloInvoker : global::Java.Lang.Object, ISayHello {

		internal    new     static  readonly    JniPeerMembers  _members    = new JniPeerMembers ("com/example/co/helloaar/SayHello", typeof (ISayHelloInvoker));
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.",
							JNIEnv.GetClassNameFromInstance (handle), "com.example.co.helloaar.SayHello"));
			return handle;
		}
...
#pragma warning disable 0169
		...
		{
			global::Com.Example.CO.Helloaar.ISayHello __this = global::Java.Lang.Object.GetObject<global::Com.Example.CO.Helloaar.ISayHello> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
